...
contextBridge.exposeInMainWorld("stockApi", {
  ...
  saveLicenseKey: (key) => ipcRenderer.invoke("license:save", key),
  getLicenseKey: () => ipcRenderer.invoke("license:load"),
  getDeviceFingerprint: () => ipcRenderer.invoke("device:fingerprint"),
  validateLicenseServer: (key) => ipcRenderer.invoke("license:validate-server", key)
});
